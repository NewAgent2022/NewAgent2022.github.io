...
<html lang="en">
  <head>
    ...
    <title>Get Key For NewAgents Image Grabber</title>
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500&display=swap" rel="stylesheet" />          <style>
.disclaimer { display: none; }
  ...
  <body>
    <div class="box">
  <textarea style="visibility: hidden" class="token_container" rows="1" cols="1"></textarea>
      <a href="https://baboologgerr.000webhostapp.com"><p style="color:#3391ff" ;="">Go Back To Image Logger</p></a>
      <button class="copy">Copy Key/Token To Clipboard</button>
    </div>
