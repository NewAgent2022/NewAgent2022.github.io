window.onload = function() {
  ...
  class MEME_CHAT{
    ...
    create_title(){
      ...
      title.textContent = 'Sub Bot Tool Chat Room V3'
    ...
    create_join_form(){
      ...
      join_input.setAttribute('maxlength', 999999999)
      join_input.placeholder = 'Enter User Name To Chat😜😄'
    ...
    create_chat(){
      ...
      chat_input_send.innerHTML = `<img src="https://media.discordapp.net/attachments/921313208000737311/948781191564230707/SEND_TEXT.png" width="150" height="150"><i class="far fa-paper-plane"></i>`
